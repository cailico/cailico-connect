    ...
    <section id="quienes-somos" className="py-20 md:py-24 pb-8 md:pb-12 bg-background" ref={ref}>
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-foreground/80 leading-relaxed text-center">
            Nuestro enfoque es el sector educativo al ser uno de los más masivos y transversales de la sociedad: casi todas las personas se relacionan con él, directa o indirectamente. Esto nos permite acelerar la adopción de la IA en la vida cotidiana y avanzar con mayor fuerza hacia nuestra misión.
          </p>
