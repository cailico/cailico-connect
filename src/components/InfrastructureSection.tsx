...
const InfrastructureSection = () => {
  ...
  return (
    <section id="infrastructure" className="relative py-8 md:py-12 bg-background" ref={ref}>
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-16 xl:px-24 relative z-10">
        ...
        >
          ...
          <button
            onClick={goToPrev}
            className="hidden md:flex shrink-0 items-center justify-center text-white/70 hover:text-secondary transition-colors"
            aria-label="Anterior"
          >
