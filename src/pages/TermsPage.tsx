        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <article className="prose prose-lg max-w-none">
            ...
            <div className="bg-primary/5 p-6 rounded-lg mb-8 border border-primary/10">
              <h2 className="text-xl font-semibold text-gray-900 mt-0">¡GRACIAS POR ELEGIR CAILICO!</h2>
            ...
            <h2 className="text-gray-900">1. Servicios de Cailico</h2>
            <h3 className="text-gray-900">1.1 Descripción General del Servicio</h3>
            <p className="text-gray-700">
              Cailico SAS es una empresa colombiana especializada en desarrollar infraestructuras de inteligencia artificial para instituciones educativas. El servicio principal que ofrece Cailico es la implementación de la <strong className="text-gray-900">Infraestructura AIPEC</strong> (Artificial Intelligence Powered Educational Communication - Comunicación Educativa Potenciada por Inteligencia Artificial) en instituciones educativas.
            </p>

            <h3 className="text-gray-900">1.2 Componentes de la Infraestructura AIPEC</h3>
            <h4 className="text-gray-900">Agente Institucional de WhatsApp</h4>
            <p className="text-gray-700">
            ...
            <h4 className="text-gray-900">Plataforma de Notas</h4>
            <p className="text-gray-700">
              Plataforma web especializada para la gestión académica institucional, accesible para docentes, rector y coordinadores.
            </p>

            <h2 className="text-gray-900">2. Registro y Activación del Servicio</h2>
            <p className="text-gray-700">Para hacer uso de la infraestructura AIPEC, la institución educativa debe:</p>
            ...
            <h2 className="text-gray-900">3. Modelo de Precios y Pagos</h2>
            <h3 className="text-gray-900">3.1 Estructura de Pagos</h3>
            <p className="text-gray-700">El servicio funciona bajo un modelo de dos componentes:</p>
            <ul className="text-gray-700">
              <li><strong className="text-gray-900">Pago Inicial:</strong> Desarrollo, adaptación, configuración y despliegue de la infraestructura AIPEC personalizada, incluyendo el primer mes de uso.</li>
              <li><strong className="text-gray-900">Pagos Mensuales:</strong> Mantenimiento, soporte continuo y mejora de la infraestructura.</li>
            </ul>

            <h2 className="text-gray-900">4. Política de Cancelación y Terminación</h2>
            <p className="text-gray-700">
            ...
            <h2 className="text-gray-900">5. Responsabilidades y Deberes de la Institución</h2>
            <ul className="text-gray-700">
            ...
            <h2 className="text-gray-900">6. Propiedad Intelectual</h2>
            <p className="text-gray-700">
            ...
            <h2 className="text-gray-900">7. Tratamiento de Datos Personales</h2>
            <p className="text-gray-700">
            ...
            <h2 className="text-gray-900">8. Limitación de Responsabilidad</h2>
            <p className="text-gray-700">
            ...
            <h2 className="text-gray-900">9. Resolución de Controversias</h2>
            <p className="text-gray-700">
            ...
            <h2 className="text-gray-900">10. Información de Contacto</h2>
            <ul className="text-gray-700">
