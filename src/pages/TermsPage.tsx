      ...
      <main className="pt-24 md:pt-32 pb-16">
        <div className="container mx-auto px-4 max-w-4xl">
          <article className="prose prose-lg max-w-none prose-headings:text-gray-900 prose-p:text-gray-700 prose-li:text-gray-700 prose-strong:text-gray-900">
            ...
            <h2>1. Servicios de Cailico</h2>
            <h3>1.1 Descripción General del Servicio</h3>
            <p>
            ...
            <h3>1.2 Componentes de la Infraestructura AIPEC</h3>
            <h4>Agente Institucional de WhatsApp</h4>
            <p>
            ...
            <h2>2. Registro y Activación del Servicio</h2>
            ...
            <h2>3. Modelo de Precios y Pagos</h2>
            <h3>3.1 Estructura de Pagos</h3>
            ...
            <h2>4. Política de Cancelación y Terminación</h2>
            <p>
            ...
            <h2>5. Responsabilidades y Deberes de la Institución</h2>
            <ul>
            ...
            <h2>9. Resolución de Controversias</h2>
            <p>
