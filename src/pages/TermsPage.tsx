      ...
      <main className="pt-24 md:pt-32 pb-16">
        <div className="container mx-auto px-4 max-w-4xl">
          <article className="prose prose-lg max-w-none prose-headings:text-gray-900 prose-p:text-gray-700 prose-li:text-gray-700 prose-strong:text-gray-900">
            <h1 className="text-3xl md:text-4xl font-bold text-[hsl(209,52%,22%)] mb-2">
              Términos y Condiciones de Uso de la Infraestructura AIPEC
            </h1>
            <p className="text-gray-500 mb-8">
              <strong className="text-gray-900">CAILICO SAS</strong> | Vigencia: Enero de 2026
            </p>

            <div className="bg-[hsl(209,52%,22%,0.05)] p-6 rounded-lg mb-8 border border-[hsl(209,52%,22%,0.1)]">
            ...
            <div className="mt-12 pt-8 border-t border-gray-200">
              <p className="text-sm text-gray-500">
                <strong className="text-gray-900">CAILICO SAS</strong><br />
                NIT: 901697615-9<br />
