      ...
      <main className="pt-24 md:pt-32 pb-16">
        <div className="container mx-auto px-4 max-w-4xl">
          <article className="prose prose-lg max-w-none prose-headings:text-foreground prose-p:text-foreground/80 prose-li:text-foreground/80 prose-strong:text-foreground">
            ...
            <h2 className="text-foreground">1. Introducción y Objetivos</h2>
            <p>
            ...
            <h3 className="text-foreground">1.1 Ámbito de Aplicación</h3>
            ...
            <h2 className="text-foreground">2. Definiciones</h2>
            <ul>
            ...
            <h2 className="text-foreground">3. Identificación del Responsable</h2>
            <ul>
            ...
            <h2 className="text-foreground">4. Datos Personales Tratados</h2>
            <h3 className="text-foreground">Datos de Estudiantes</h3>
            <ul>
            ...
            <h3 className="text-foreground">Datos de Padres de Familia</h3>
            <ul>
            ...
            <h3 className="text-foreground">Datos de Profesores y Directivos</h3>
            <ul>
            ...
            <h2 className="text-foreground">5. Principios Rectores del Tratamiento</h2>
            <ul>
            ...
            <h2 className="text-foreground">6. Finalidades del Tratamiento</h2>
            <ul>
            ...
            <h2 className="text-foreground">7. Derechos de los Titulares</h2>
            <ul>
            ...
            <h2 className="text-foreground">8. Medidas de Seguridad</h2>
            <h3 className="text-foreground">Medidas Técnicas</h3>
            <ul>
            ...
            <h3 className="text-foreground">Medidas Administrativas</h3>
            <ul>
            ...
            <h2 className="text-foreground">9. Procedimiento para el Ejercicio de Derechos</h2>
            <h3 className="text-foreground">Canales de Atención</h3>
            <ul>
            ...
            <h3 className="text-foreground">Términos de Respuesta</h3>
            <p>
              Consultas: máximo 10 días hábiles (prorrogables 5 días más)<br />
              Reclamos: máximo 15 días hábiles (prorrogables 8 días más)
            </p>

            <h2 className="text-foreground">10. Conservación y Supresión de Datos</h2>
            <p>
            ...
            <h2 className="text-foreground">11. Contacto</h2>
            <ul>
              <li><strong>WhatsApp:</strong> (+57) 301 624 1863</li>
              <li><strong>Correo electrónico:</strong> contacto@cailico.com</li>
